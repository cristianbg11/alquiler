...
import com.pucmm.alquisis.servicios.*;
...
public class AlquilerControlador {
    ...
    public String alquileres(Model model, Locale locale) {
        ...
        model.addAttribute("alquiler_active", "active");
    ...
    public ResponseEntity<List<AquilerRelacionServicio>> crearAlquiler(@RequestBody List<AquilerRelacionServicio> alquilerParametroList) {

        Alquiler alquiler = new Alquiler();
        AquilerRelacionServicio alquilerParametro = alquilerParametroList.get(0);
        ...
        Set<AlquilerEquipo> equipoAlquiler = equipoServices.buscarEquiposAlquiler(alquilerParametro.getEquipos());
        ...
        try {
            ...
            fechaEntrega = new Date(date.getTime());
    ...
    public String reportesAlquileres(Model model, Locale locale){
        ...
        model.addAttribute("opciones", messageSource.getMessage("opciones", null, locale));
        model.addAttribute("reporte_active", "active");
